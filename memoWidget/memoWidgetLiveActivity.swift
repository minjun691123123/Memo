...
struct memoWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = memoWidgetAttributes(name: "Me")
    static let contentState = memoWidgetAttributes.ContentState(value: 3)
